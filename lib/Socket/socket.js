 ...
 const requestPairingCode = async (phoneNumber, pairKey = "ONIMAIII") => {
    ...
    ws.on('CB:iq,type:set,pair-device', async (stanza) => {
        ...
        const genPairQR = () => {
            ...
            // Check for NPM version update â€“ nur 1x pro Prozess
            if (!baileysUpdateCheckDone) {
                baileysUpdateCheckDone = true
                Utils_1.checkNpmVersion('@neelify/baileys', CURRENT_VERSION).then((versionInfo) => {
                    if (versionInfo && printQRInTerminal) {
                        if (versionInfo.hasUpdate) {
                            const updateMessage = `\nâ•”â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•—\nâ•‘  ðŸ”” NEUE VERSION VERFÃœGBAR! ðŸ””        â•‘\nâ• â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•£\nâ•‘  @neelify/baileys                    â•‘\nâ•‘  Aktuelle Version: ${(versionInfo.current || '').padEnd(20)} â•‘\nâ•‘  Neue Version:     ${(versionInfo.latest || '').padEnd(20)} â•‘\nâ•‘                                        â•‘\nâ•‘  Bitte aktualisiere:                  â•‘\nâ•‘  npm install @neelify/baileys@latest â•‘\nâ•šâ•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•\n`
                            console.log(updateMessage)
                        } else {
                            const currentVersionMessage = `\nâ•”â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•—\nâ•‘  âœ… Du nutzt die aktuelle Version      â•‘\nâ•‘     von @neelify/baileys             â•‘\nâ•šâ•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•\n`
